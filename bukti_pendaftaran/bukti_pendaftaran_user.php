...
$sql = mysqli_query($koneksi, "SELECT * FROM pendaftaran,sekolah WHERE pendaftaran.asal_sekolah=sekolah.id_sekolah AND id_pendaftaran='$_GET[no_pendaftaran]'");
...
$pdf->Cell(4,10,':',1,0,'L');
$pdf->Cell(70,10,'PPDB/',1,0,'L'); $pdf->text(78,66.3,$r['id_pendaftaran'],1,0,'L'); $pdf->text(84,66.3,'/2020',1,0,'L');
$pdf->Ln();
