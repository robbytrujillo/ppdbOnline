  ...
  $detail=mysqli_query($koneksi, "SELECT * FROM agenda,users  WHERE tema_seo='$_GET[tema]'");
  ...
  mysqli_query($koneksi, "UPDATE agenda  SET dibaca='$baca'  WHERE tema_seo='$_GET[tema]'");
