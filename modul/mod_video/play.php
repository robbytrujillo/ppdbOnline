  ...
  $detail888=mysqli_query($koneksi, "SELECT * FROM video WHERE id_video=$d[id_video]");
  ...
  $komentar = mysqli_query($koneksi, "select count(komentarvid.id_komentar) as jml from komentarvid WHERE id_video='$_GET[id]' AND aktif='Y'");
  ...
  $sql = mysqli_query($koneksi, "SELECT * FROM komentarvid WHERE id_video='$_GET[id]' AND aktif='Y' LIMIT $posisi,$batas");
  ...
  $jmldata     = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM komentarvid WHERE id_video='$_GET[id]' AND aktif='Y'"));
 ...
 <!------------- TABS BERITA -------------------->
  ...
  $sql=mysqli_query($koneksi, "SELECT * FROM berita ORDER BY dibaca DESC LIMIT 5"); 
  ...
  <div class="list">
  <?php    
  $komentar=mysqli_query($koneksi, "SELECT * FROM berita,komentar 
  ...
  <?php    
  $agenda=mysqli_query($koneksi, "SELECT * FROM agenda ORDER BY rand() DESC LIMIT 6");
  ...
  <div class="photos">
  <?php
  $pasangiklan=mysqli_query($koneksi, "SELECT * FROM pasangiklan ORDER BY rand() LIMIT 2");
